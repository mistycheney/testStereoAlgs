...
template void ScaleAndOffsetLine<uchar, uchar>(uchar*, uchar*, int,float,float,uchar, uchar);
template void ScaleAndOffsetLine<int, int>(int*, int*, int,float,float,int, int);
template void ScaleAndOffsetLine<float, float>(float*, float*, int,float,float,float, float);
